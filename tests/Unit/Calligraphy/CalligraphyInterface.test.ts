...
import {
  TEST_CALLIGRAPHY_CATEGORY, TEST_CALLIGRAPHY_CATEGORY_CHARACTERS,
  TEST_CALLIGRAPHY_CATEGORY_ID, TEST_CALLIGRAPHY_INVALID_EVALUATION_RESULT, TEST_CALLIGRAPHY_INVALID_GROUPING,
  TEST_CALLIGRAPHY_JLPT_GROUPING, TEST_CALLIGRAPHY_JLPT_RESIDUAL_CATEGORY,
  TEST_CALLIGRAPHY_JOYO_GROUPING, TEST_CALLIGRAPHY_JOYO_RESIDUAL_CATEGORY,
  TEST_CALLIGRAPHY_RESIDUAL_CATEGORY, TEST_CALLIGRAPHY_VISIBLE_JLPT_CATEGORIES, TEST_CALLIGRAPHY_VISIBLE_JOYO_CATEGORIES
