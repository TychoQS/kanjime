...
features2d = {
    'SIFT': ['create', 'setNFeatures', 'getNFeatures', 'setNOctaveLayers', 'getNOctaveLayers', 'setContrastThreshold', 'getContrastThreshold', 'setEdgeThreshold', 'getEdgeThreshold', 'setSigma', 'getSigma', 'getDefaultName'],'Feature2D': ['detect', 'compute', 'detectAndCompute', 'descriptorSize', 'descriptorType', 'defaultNorm', 'empty', 'getDefaultName'],
